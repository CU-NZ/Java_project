...
import com.item.chatroom.config.FreeMarkListner;
import com.item.chatroom.service.AccountService;
import com.item.chatroom.utils.CommUtils;
...
public class LoginController extends HttpServlet {
    ...
    private Template getTemplate(HttpServletRequest req,String fileName) {
        Configuration cfg = (Configuration)
                req.getServletContext().getAttribute(FreeMarkListner.TEMPLATE_KEY);
        try {
